...
route_id_in_body = BodyField(name='id', type='integer', description='路由节点ID', enum=[1, 2, 3, 4])
route_id_in_path = IntegerPathFiled(name='id', description='路由节点ID', enum=[1, 2, 3, 4, 23, 24, 25])
...
nodes_in_body = BodyField(name='route_tree', type='array', description='修改后完整路由结构', enum=[[{'id': 2, 'children': [{'id': 5}, {'id': 6}]}, {'id': 3}]])
